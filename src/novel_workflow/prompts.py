...
每个核心角色需具备 1-2 个可被一眼记住的外在标志、口头禅或习惯性小动作，适配漫画/动画化表现，强化角色视觉辨识度。
统一梳理全员人物关系、羁绊联结、立场对立体系，情感羁绊、团队羁绊、敌我冲突完全闭环，无逻辑漏洞、无狗血割裂设定。人物关系优先围绕主角的情感位、功能位、冲突位进行设计。
全文文风贴合作品整体调性，简洁高级、立体生动，字数控制在 500-2000 字，适配官方人设档案标准。
...
- 情节连贯，与前述章节内容自然衔接
- 保持设定的写作风格与基调
- 保持轻小说叙事特征：主角视角鲜明，内心独白/吐槽适度，对话占比高，人物互动优先推动情节，场景描写服务于角色情绪
- 字数接近设定的每章字数目标
...
5. 每个核心角色是否有可被一眼记住的外在标志、口头禅或习惯性小动作，适配漫画/动画化表现？
6. 字数是否符合要求（500-2000字）？
