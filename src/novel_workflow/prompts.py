...
- **视觉标识强制落地**：每位核心角色固定 1 个专属外形标识 + 1 个习惯性小动作 / 微表情，适配漫改镜头、高辨识度、轻小说标签化记忆点。
...
视觉 & 记忆点：每位核心角色均具备专属外在标志、口头禅或习惯性小动作，造型与行为特征鲜明，适配漫画、动画镜头表现。
