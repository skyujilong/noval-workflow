...
- **题材**: 末日求生
- **节点**: `foreshadowing` (prepare)
- **fixture 说明**: fixture: 已有 1 条 pending 伏笔,读第 4 章末更新
- **system 长度**: 495 字
- **context 长度**: 2390 字
- **task 长度**: 1612 字
...
【本次任务】
请根据已完成的章节内容，更新【伏笔台账】。当前所处章节：第3章。
...
要求：
- pending（悬置）：列出当前所有仍待兑现的伏笔，必须包含上次台账中全部悬置项，本批无变化者原文保留
