...
- **题材**: 玄幻
- **节点**: `phase_summary` (prepare)
- **fixture 说明**: fixture: 已有第 0 章基线,读第 4 章末更新
- **system 长度**: 497 字
- **context 长度**: 2388 字
- **task 长度**: 912 字
...
要求：
- **只固化上方【固化角色名单】中列出的角色**，名单外的角色（次要角色 / 龙套 / 一次性配角）一律不建分块；名单内角色即使本批无戏份也须保留上次条目
- 完整保留上次快照中所有条目，本批无变化者直接沿用原文；有变化者标注【变化】
