...
- **题材**: 搞笑异世界
- **节点**: `world_building` (prepare)
- **fixture 说明**: fixture: 已有 core_theme,尚无 world_building
- **system 长度**: 547 字
- **context 长度**: 2726 字
- **task 长度**: 1543 字
...
- 字数：400-800字
- 题材聚焦：标准 RPG 类中世纪奇幻背景（公会、职业、等级、技能、魔王军、新手村），但填充要有荒诞点（会飞的蔬菜、田里挖的秋刀鱼、森林野生章鱼、圣属性职业却精进世俗才艺、防御向职业却精通被虐哲学等）。**穿越者用现代日本视角吐槽异世界规则**的错位感是核心气质。严禁写成正经史诗奇幻或热血修真世界。
