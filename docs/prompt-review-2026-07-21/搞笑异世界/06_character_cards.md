...
- 题材聚焦：**核心配角必须遵循「尊贵身份 × 致命废柴属性」反差公式**，且反差本身是剧情驱动力，不是装饰。反差范式 slot（原创角色须落在下列 slot 之上，但**禁止照搬参考作品的三人组，需自创新名字 / 新细节 / 新背景，避免抄袭嫌疑**）：
...
**卡司≥4 人小队群像**（主角+3-5 位性格各异的核心配角）；主角走「反龙傲天+吐槽担当」人设，`ability_contract` 明确锚定「战力几乎不涨，靠信息差/耍赖/算计/道具/口才/盗贼技能『偷』赢」，禁止给主角写「隐藏血脉/根源体质/未觉醒天赋」这类线性升级伏笔。**反派也建卡**且必须有活人怪癖字段。全员 `speech_style` 要拉开语域大反差（现代宅腔 / 中二腔 / 圣女腔 / 神职没文化腔 / 高贵变态腔 / 猥琐奸商腔）。
