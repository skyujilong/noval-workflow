...
## 最短合规样本（题材化示范）
[
  {"chapter": 4, "purpose": "主角初入陌生环境被排挤，埋下反制契机", "key_turn": "无意间抓到关键信息，看破对手一处破绽", "ending_hook": "主角把这条信息写进随身笔记，只画了一个圈", "intensity": "铺垫"},
  {"chapter": 5, "purpose": "主角首次主动出手，展露真实一面", "key_turn": "利用信息差反将一军，被暗中观察者留意", "ending_hook": "观察者在名册上悄悄把主角标了颜色", "intensity": "小转折"}
]
...
2. 每 5 章内主角必须有至少一次「主角时刻」——本题材下的具体形态：**主动决策、关键胜利或收获、能力或身份被目击、信息优势、关系突破、获得关键契机**。读者必须能感受到主角有能动性。
...
3. 能力 / 资源 / 身份 / 立场跃迁**必须有铺垫章在前**（学习、积累、失落、休整、思考、试错），禁止「上一章还没起势，下一章直接跨阶段跳变」的跃迁式升级。
