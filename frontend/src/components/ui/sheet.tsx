// 抽屉（侧边滑出面板）：基于 @radix-ui/react-dialog 原语，与 dialog 同栈。
// 适合字段较多的表单——占满视口高度、纵向滚动，比居中弹窗空间更大。
  ...
  "fixed z-50 gap-4 bg-background p-6 shadow-lg transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:duration-500",
  {
    variants: {
      side: {
        ...
        right:
          "inset-y-0 right-0 h-full w-4/5 border-l data-[state=closed]:slide-out-to-right data-[state=open]:slide-in-from-right max-w-[1000px]",
      },
    },
    defaultVariants: {
      side: "right",
